...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ed999feba6c1eaf7465ced31eef1a090">
</script>
...
<script type="text/javascript">
	$(function(){
	    ...
	    var mapContainer = document.getElementById("map");
		 // 지도를 생성할때 필요한 기본 옵션
	    var options = {
		    center: new kakao.maps.LatLng(37.496719, 127.025364), // 한독빌딩 좌표
		    level: 4  // 지도의 확대/축소 레벨
		};
	    ...
	    var mapTypeControl = new kakao.maps.MapTypeControl();
	 	...
	 	// 지도 타입 컨트롤을 지도에 표시함.
	    // kakao.maps.ControlPosition은 컨트롤이 표시될 위치를 정의하는데 TOPRIGHT는 오른쪽 위를 의미함. ( 위치값 의미 ) 
	    ...
	    // GeoLocation을 이용해서 웹페이지에 접속한 사용자의 현재 위치를 확인하여 그 위치(위도,경도)를 지도의 중앙에 오도록 한다.
		   navigator.geolocation.getCurrentPosition(function(position) {
			       ...
			       var imageSrc = '<%= ctxPath%>/images/pointerPink.png'; 
	          ...
	          var locPosition = new kakao.maps.LatLng(37.496719, 127.025364);     
