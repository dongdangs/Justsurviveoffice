...
<div class="col-md-10 bg-light p-4 rounded"> 
    <div style="width:100%; min-height:700px; margin:auto;"> 
        <h2 class="mb-4 text-primary">가입자 통계</h2> 
        
        <!-- ✅ 통계 종류 + 월 선택 -->
        <form id="searchForm" method="get" action="<%= ctxPath%>/admin/userExcelList" class="form-inline mb-3">
            <label for="chartSelect" class="mr-2 font-weight-bold text-secondary">통계 종류:</label>
            <select id="chartSelect" name="chart" onchange="this.form.submit()" class="form-control mr-3">
            ...
            <c:if test="${chart eq 'registerDay'}">
                <label for="monthSelect" class="mr-2 font-weight-bold text-secondary">월:</label>
                <select id="monthSelect" name="month" onchange="this.form.submit()" class="form-control">
        ...
        <div class="table-container"> 
            <table id="statTable" class="table table-bordered table-hover text-center"> 
