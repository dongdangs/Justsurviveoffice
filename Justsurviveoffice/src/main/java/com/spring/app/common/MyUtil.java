...
public class MyUtil {
	...
	//	System.out.println("확인용 queryString : " + queryString);
		...
		if(queryString != null) {	// GET 방식일 경우
			...
			// 확인용 currentURL : http://localhost:9090/myspring/board/add?name=superman&age=30
			// 확인용 currentURL : http://localhost:9090/myspring/board/add?name=%EC%8A%88%ED%8D%BC%EB%A7%A8&age=30
		}
