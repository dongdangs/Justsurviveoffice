...
public class AdminService_imple implements AdminService {
	...
	// 회원목록 전체보기(페이징 처리)
	@Override
	public Page<Users> getPageUserList(String searchType, String searchWord, int currentShowPageNo, int sizePerPage) 
										throws Exception {
		...
		try {
			...
			page = new PageImpl<>(usersList, pageable, total != null ? total : 0);
